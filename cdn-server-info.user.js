...
// @version      7.7.0
// @description  [v7.7.0] Updated ChinaCache to EdgeNext with new logo. Added POP extraction for ChinaNetCenter. Updated Akamai logo. Enhanced LiteSpeed cache detection and CSS isolation.
// @description:en [v7.7.0] Updated ChinaCache to EdgeNext with new logo. Added POP extraction for ChinaNetCenter. Updated Akamai logo. Enhanced LiteSpeed cache detection and CSS isolation.
// @author       Zhou Sulong
// @license      MIT
// @match        *://*/*

...
// @version      7.5.1
// @description  [v7.5.1] Fixed Akamai logo display using official SVG. Enhanced LiteSpeed cache detection (x-litespeed-cache, x-lsadc-cache). Improved CSS isolation for consistent panel rendering across sites.
// @description:en [v7.5.1] Fixed Akamai logo display using official SVG. Enhanced LiteSpeed cache detection (x-litespeed-cache, x-lsadc-cache). Improved CSS isolation for consistent panel rendering across sites.
// @author       Zhou Sulong
// @license      MIT
// @match        *://*/*
...
// @resource     cdn_rules https://raw.githubusercontent.com/zhousulong/cdn-server-info-userscript/main/cdn_rules.json?v=7.5.1

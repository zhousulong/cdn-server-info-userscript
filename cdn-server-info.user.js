...
// @version      7.50.2
// @description  [v7.50.2] Added OVHcloud CDN detection; Added VergeCloud CDN detection; Added Qiniu Cloud SVG icon and CNAME fingerprint (qncdn); Added Tencent Cloud CNAME fingerprint (qcloudzygj); Added CDNetworks CNAME fingerprint (cdn20); Added JD Cloud CNAME fingerprints (jcloud-cdn, jcloudlb) and SVG icon; Added Huawei Cloud CNAME fingerprint (cdnhwcgqa21).
// @description:en [v7.50.2] Added OVHcloud CDN detection; Added VergeCloud CDN detection; Added Qiniu Cloud SVG icon and CNAME fingerprint (qncdn); Added Tencent Cloud CNAME fingerprint (qcloudzygj); Added CDNetworks CNAME fingerprint (cdn20); Added JD Cloud CNAME fingerprints (jcloud-cdn, jcloudlb) and SVG icon; Added Huawei Cloud CNAME fingerprint (cdnhwcgqa21).
// @author       Zhou Sulong
// @license      MIT
// @match        *://*/*
...
// @resource     cdn_rules https://raw.githubusercontent.com/zhousulong/cdn-server-info-userscript/main/cdn_rules.json?v=7.50.2

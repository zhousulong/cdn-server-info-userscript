...
// @resource     cdn_rules https://raw.githubusercontent.com/zhousulong/cdn-server-info-userscript/main/cdn_rules.json?v=7.56.6
...
(function () {
    ...
    function setupScrollCollapse(host, panelElement) {
        ...
        function setTransformOrigin() {
            ...
            // Set transform origin to SAME corner as panel position
            // If panel is in bottom-right, set origin to bottom-right
            // So it stays anchored at bottom-right when collapsing/expanding
            ...
            console.log(`[CDN Panel] Center: (${Math.round(centerX)}, ${Math.round(centerY)}), Position: ${isRight ? 'Right' : 'Left'}-${isBottom ? 'Bottom' : 'Top'}, Origin: ${origin}`);
        }

        // Handle scroll events
        function handleScroll() {
            // Set transform origin before collapsing
            setTransformOrigin();
        ...
        panelElement.addEventListener('click', (e) => {
            if (panelElement.classList.contains('collapsed')) {
                ...
                // Set transform origin for expand animation
                setTransformOrigin();

// ==UserScript==
// @name         CDN & Server Info Displayer (noframes)
// @name:en      CDN & Server Info Displayer (noframes)
// @namespace    http://tampermonkey.net/
// @version      5.5.0
// @description  [v5.5.0 优化] 新增 @noframes 指令，禁止脚本在任何<iframe>或<frame>中运行，并移除了相关的冗余判断代码，提升效率。
// @description:en [v5.5.0 Optimization] Added @noframes directive to prevent the script from running in any iframes or frames, and removed related redundant code for efficiency.
// @author       Gemini (AI Optimization)
// @license      MIT
// @match        *://*/*
// @grant        GM_addStyle
...
(function() {
    ...
    function createDisplayPanel(info) {
        ...
        panel.innerHTML = `
            ...
            <div class="info-line">
                ...
                <span class="info-value ${cacheStatus.includes('HIT') ? 'cache-HIT' : 'cache-MISS'}">${info.cache}</span>
            </div>
            <div class="info-line">
    ...
    function shouldExcludePage() {
        // 由于 @noframes 的存在， `window !== window.top` 的检查已不再需要。

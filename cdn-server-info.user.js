...
(function () {
    ...
    const cdnIcons = {
        ...
        'Akamai': `<svg viewBox="0 0 410 167"><path fill="currentColor" d="M293.6 88.3c-8.2 2.5-14.1 10-14.1 19 0 9 6.1 16.6 14.4 19.1.8.2.6.8-.4.8-11 0-20-8.9-20-19.9s9-19.9 20-19.9c.9 0 .9.6 0 .9m-10.3 14.3c-.1.5-.1 1.1-.1 1.6 0 8.7 7.1 15.8 15.8 15.8 8.2 0 10.7-3.7 11-3.4.3.3-3 7.6-12.7 7.6-8.7 0-15.8-7.1-15.8-15.8 0-2 .4-3.9 1.1-5.7.2-.7.7-.7.7-.1m6.6 11.4c4.1 1.8 9.3 1.9 14.3.1 3.4-1.2 5.4-2.9 5.5-2.8.3.1-2 3.7-6.1 5.2-4.7 1.7-9.6.8-13.2-2.2-.4-.3-.3-.5.5-.3"/><path fill="currentColor" d="m316.1 99.8.3-2.8h4.4l-1.5 16.1h-6.5l-8.3-16.1h4.5l1.4 2.8zm-.2 3.1h-4l3.4 7h.1zm10.7 4.2h.7l3.1 4.3h4.1l-4.3-5.4 2.6-5.9h-4.3l-1.7 4.6h-.6l-1-4.6h-3.7l3.4 16.1h3.7zm13.8-6.2h3.7l1.5 7c.8 3.9-.7 4.3-4.4 4.3-2.6 0-5.2 0-5.9-3.5h3.7c.2 1 .8 1.2 1.8 1.2 1.6 0 1.5-.7 1.3-1.7l-.3-1.4h-.2c-.1 1.3-1.7 1.3-2.7 1.3-2.7 0-4.3-.9-4.8-3.6-.6-2.9.8-3.5 3.3-3.5 1.3 0 3 .3 3.6 1.8h.1zm-1 4.7c1.2 0 2-.1 1.8-1.1-.3-1.2-.8-1.4-2.4-1.4-.6 0-1.6 0-1.4 1.2.2 1.1.9 1.3 1.9 1.3m11.2 5.5-.3-1.6h.2c.7 1.3 2.2 1.7 3.5 1.7 1.6 0 3.2-.3 2.9-2.2h.2c.5 1.6 2.2 2.2 3.6 2.2 2.6 0 3.7-1.1 3.2-3.7l-1.5-6.5h-3.7l1.4 6.5c.2 1.2.3 2.1-1 2.1s-1.9-.9-2.2-2.2l-1.4-6.4h-3.7l1.5 6.8c.2 1 .3 1.7-1 1.7-1.5 0-2-.8-2.3-2.2l-1.5-6.3h-3.7l2.4 11.2zm21.1-11.2h3.7l1.5 7c.8 3.9-.7 4.3-4.4 4.3-2.6 0-5.2 0-5.9-3.5h3.7c.2 1 .8 1.2 1.8 1.2 1.6 0 1.5-.7 1.3-1.7l-.3-1.4h-.2c-.1 1.3-1.7 1.3-2.7 1.3-2.7 0-4.3-.9-4.8-3.6-.6-2.9.8-3.5 3.3-3.5 1.3 0 3 .3 3.6 1.8h.1zm-1 4.7c1.2 0 2-.1 1.8-1.1-.3-1.2-.8-1.4-2.4-1.4-.6 0-1.6 0-1.4 1.2.2 1.1.9 1.3 1.9 1.3m8.9-4.7h-3.7l2.4 11.2h3.7z"/></svg>`,

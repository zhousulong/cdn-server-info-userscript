...
// @version      7.9.9
// @description  [v7.9.9] Fixed logos to use currentColor for gray watermark style.
// @description:en [v7.9.9] Fixed logos to use currentColor for gray watermark style.
// @author       Zhou Sulong
// @license      MIT
// @match        *://*/*
...
// @resource     cdn_rules https://raw.githubusercontent.com/zhousulong/cdn-server-info-userscript/main/cdn_rules.json?v=7.9.9

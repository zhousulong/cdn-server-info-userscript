...
const humbleHeaders = {
    ...
    'Akamai-Cache-Status': 'Akamai Edge',
    ...
    'Cache-Provider': 'cloudways.com Platform',
    ...
    'CF-Placement': 'Cloudflare Workers',
    ...
    'Host-Header': 'Virtual host to use',
    'HTTP_X_Shopify_Shop_API_Call_Limit': 'Shopify.com Platform',
    ...
    'Panel': 'Generic Publishing Software',
    ...
    'Shopify-Complexity-Score': 'Shopify.com Platform',
    'Shopify-Edge-IP': 'Shopify.com Platform',
    ...
    'SourceMap': 'Source map of original code',
    ...
    'X-Azhost': 'Microsoft Azure App Service',
    'X-Azion-Edge': 'azion.com Platform',
    'X-Azion-Edge-POP': 'Azion Edge Firewall',
    'X-Azion-Request-ID': 'Azion Edge Firewall',
    ...
    'X-CalculatedBETarget': 'Microsoft Exchange Server',
    ...
    'X-Envoy-Attempt-Count': 'Envoy L7 Proxy',
    ...
    'X-Interactsh-Version': 'app.interactsh.com Platform',
    ...
    'X-Joomla-Id': 'Joomla Content Management System',
    'X-Joomla-Option': 'Joomla Content Management System',
    'X-Joomla-Version': 'Joomla Content Management System',
    'X-JSL': 'Jive REST API',
    ...
    'X-Kubernetes-PF-FlowSchema-UI': 'Kubernetes cluster',
    'X-Kubernetes-PF-FlowSchema-UID': 'Kubernetes cluster',
    'X-Kubernetes-PF-PriorityLevel-UID': 'Kubernetes cluster',
    ...
    'X-MS-Gateway-RequestID': 'Microsoft Azure',
    ...
    'X-Old-Content-Length': 'IBM WebSEAL web server',
    ...
    'X-Ramp-Body-Source': 'ramp.com Platform',
    ...
    'X-Rebelmouse-Surrogate-Control': 'RebelMouse.com Platform',
    'X-Redirect-By': 'Generic Publishing Software',
    'X-Redirect-Powered-By': 'Prettylinks.com Platform',
    'X-RGW-Bytes-Used': 'ceph.io Platform',
    'X-RGW-Next-Append-Position': 'ceph.io Platform',
    'X-RGW-Object-Count': 'ceph.io Platform',
    'X-RGW-Object-Type': 'ceph.io Platform',
    'X-RGW-Quota-Bucket-Objects': 'ceph.io Platform',
    'X-RGW-Quota-Bucket-Size': 'ceph.io Platform',
    'X-RGW-Quota-Max-Buckets': 'ceph.io Platform',
    'X-RGW-Quota-User-Objects': 'ceph.io Platform',
    'X-RGW-Quota-User-Size': 'ceph.io Platform',
    'X-RGW-Replicated-From': 'ceph.io Platform',
    'X-RL-Cache': 'RabbitLoader WordPress Plugin',
    'X-RL-Modified': 'RabbitLoader WordPress Plugin',
    'X-RL-Rule': 'RabbitLoader WordPress Plugin',
    'X-Rocket-Nginx-Bypass': 'WP Rocket WordPress Plugin',
    'X-Rocket-Nginx-Device': 'WP Rocket WordPress Plugin',
    'X-Rocket-Nginx-File': 'WP Rocket WordPress Plugin',
    'X-Rocket-Nginx-Reason': 'WP Rocket WordPress Plugin',
    'X-Rocket-Nginx-Serving-Static': 'WP Rocket WordPress Plugin',
    'X-RS-CF-App-Version': 'RankSense.com Platform',
    'X-RS-Changes-Amount': 'RankSense.com Platform',
    'X-RS-Fixes-Request-Time': 'RankSense.com Platform',
    'X-RUM-NotUpdateQueriedDbCopy': 'Microsoft Outlook',
    'X-RUM-NotUpdateQueriedPath': 'Microsoft Outlook',
    'X-RUM-Validated': 'Microsoft Outlook',
    'X-Rundeck-Auth-Token': 'Rundeck API',
    'X-Rundeck-Exec-Completed': 'Rundeck API',
    'X-Rundeck-Exec-Duration': 'Rundeck API',
    'X-Rundeck-Exec-State': 'Rundeck API',
    'X-Rundeck-ExecOutput-Completed': 'Rundeck API',
    'X-Rundeck-ExecOutput-Empty': 'Rundeck API',
    'X-Rundeck-ExecOutput-Error': 'Rundeck API',
    'X-Rundeck-ExecOutput-LastModifed': 'Rundeck API',
    'X-Rundeck-ExecOutput-Message': 'Rundeck API',
    'X-Rundeck-ExecOutput-Offset': 'Rundeck API',
    'X-Rundeck-ExecOutput-TotalSize': 'Rundeck API',
    'X-Rundeck-ExecOutput-Unmodified': 'Rundeck API',
    ...
    'X-Seraph-Accel-Cache': 'Seraphinite Accelerator WordPress Plugin',
    'X-Seraph-Accel-Cont': 'Seraphinite Accelerator WordPress Plugin',
    'X-Seraph-LoginReason': 'Atlassian Seraph',
    'X-Servebolt-Plugin': 'Servebolt.com Platform',
    'X-Served-By': 'Generic HTTP Server/Content Delivery Network',
    'X-ServedBy': 'Generic HTTP Server/Content Delivery Network',
    'X-Server': 'Generic HTTP Server',
    'X-Server-Name': 'Generic HTTP Server',
    'X-Server-Powered-By': 'Generic HTTP Server/Technology',
    'X-ServerName': 'Generic HTTP Server',
    'X-SF-Properties': 'Progress Sitefinity Content Management System',
    'X-SFC-Cachable': 'TYPO3 Content Management System',
    'X-SFC-Explanation': 'TYPO3 Content Management System',
    'X-SFC-Tags': 'TYPO3 Content Management System',
    'X-SFDC-Request-ID': 'Salesforce API',
    'X-SG-CDN': 'SiteGround Content Delivery Network',
    'X-ShardId': 'Shopify.com Platform',
    'X-SharePointHealthScore': 'Microsoft SharePoint Services',
    'X-SheetKraftVersion': 'sheetkraft.com Platform',
    'X-Shopery': 'Shopery.com Platform',
    'X-ShopId': 'Shopify.com Platform',
    'X-Shopify-API-Version': 'Shopify.com Platform',
    'X-Shopify-API-Version-Warning': 'Shopify.com Platform',
    'X-Shopify-Generated-Cart-Token': 'Shopify.com Platform',
    'X-Shopify-Granular-Consent-Beta': 'Shopify.com Platform',
    'X-Shopify-Nginx-No-Cookies': 'Shopify.com Platform',
    'X-Shopify-Privacy-API-Migration-Beta': 'Shopify.com Platform',
    'X-Shopify-Request-Trackable': 'Shopify.com Platform',
    'X-Shopify-Shop-API-Call-Limit': 'Shopify.com Platform',
    'X-Shopify-Stage': 'Shopify.com Platform',
    'X-SiteID': 'Amazon Elastic Compute Cloud',
    'X-SL-CompState': 'AppWall Web Application Firewall',
    'X-Smith-Release': 'smith.ai Platform',
    'X-Smith-SQL-Count': 'smith.ai Platform',
    'X-Smugmug-Hiring': 'SmugMug eCommerce',
    'X-Smugmug-Values': 'SmugMug eCommerce',
    'X-Sorting-Hat-PodId': 'Shopify.com Platform',
    'X-Sorting-Hat-ShopId': 'Shopify.com Platform',
    'X-SourceMap': 'Source map of original code',
    'X-SourceFiles': 'Microsoft ASP.NET Framework',
    'X-SP-Metadata': 'Stackpath Content Delivery Network',
    'X-Spdwp-Ngx': 'WP Rocket WordPress Plugin',
    'X-Spip-Cache': 'SPIP Publishing Software',
    'X-SRCache-Fetch-Status': 'NGINX HTTP Server',
    'X-SRCache-Flag': 'NGINX HTTP Server',
    'X-SRCache-Store-Escaped-Key': 'NGINX HTTP Server',
    'X-SRCache-Store-Key': 'NGINX HTTP Server',
    'X-SRCache-Store-Status': 'NGINX HTTP Server',
    'X-Stackcache-Cacheable': '20i WordPress Cache Plugin',
    'X-StackifyID': 'stackify.com Platform',
    'X-Statuspage-Skip-Logging': 'Atlassian Statuspage',
    'X-StatusPage-Version': 'Atlassian Statuspage',
    'X-Store': 'epages.com Platform',
    'X-Storefront-Renderer-Rendered': 'Shopify.com Platform',
    'X-Storefront-Renderer-Verified': 'Shopify.com Platform',
    'X-Streams-Distribution': 'Generic Content Management System',
    'X-Styx-Req-ID': 'Pantheon Software as a service',
    'X-Sucuri-Cache': 'Sucuri Content Delivery Network',
    'X-Sucuri-ID': 'Sucuri Content Delivery Network',
    'X-Supplied-By': 'Generic HTTP Server/Content Delivery Network',
    'X-Supported-By': 'Generic HTTP Server/Content Delivery Network',
    'X-Sveltekit-Page': 'SvelteKit Framework',
    'X-Swift-CacheTime': 'Alibaba Cloud Content Delivery Network',
    'X-Swift-SaveTime': 'Alibaba Cloud Content Delivery Network',
    'X-Symfony-Cache': 'Symfony PHP Framework',
    'X-TEC-API-ORIGIN': 'The Events Calendar WordPress Plugin',
    'X-TEC-API-ROOT': 'The Events Calendar WordPress Plugin',
    'X-TEC-API-VERSION': 'The Events Calendar WordPress Plugin',
    'X-Tencent-Ua': 'tencent.com platform',
    'X-TimeAS': 'epages.com Platform',
    'X-Tncms': 'Generic Content Management System',
    'X-TransIP-Backend': 'TransIP Web Application Firewall',
    'X-TransIP-Balancer': 'TransIP Web Application Firewall',
    'X-Trove-App-Name': 'Trove Database as a Service',
    'X-Trove-Country-Code': 'Trove Database as a Service',
    'X-Trove-Order-UUID': 'Trove Database as a Service',
    'X-TT-Agw-Login': 'toutiao.com platform',
    ...
    'X-Two-Optimize-Reason': '10web.io Platform',
    'X-Two-Page-Cached': '10web.io Platform',
    'X-Two-Page-Is-Optimized': '10web.io Platform',
    'X-Two-Version': '10web.io Platform',
    'X-Two-Webp': '10web.io Platform',
    'X-Umbraco-Version': 'Umbraco Content Management System',
    'X-Unbounce-Instance': 'unbounce.com Platform',
    'X-Unbounce-PageID': 'unbounce.com Platform',
    'X-Unbounce-Variant': 'unbounce.com Platform',
    'X-Unbounce-VisitorID': 'unbounce.com Platform',
    'X-Using-Nginx-Controller': 'NGINX HTTP Server',
    'X-Varnish': 'Varnish HTTP Accelerator',
    'X-Varnish-Age': 'Varnish HTTP Accelerator',
    'X-Varnish-Backend': 'Varnish HTTP Accelerator',
    'X-Varnish-Cache': 'Varnish HTTP Accelerator',
    'X-Varnish-CC': 'Varnish HTTP Accelerator',
    'X-Varnish-Debug-TTL': 'Varnish HTTP Accelerator',
    'X-Varnish-ESI': 'Varnish HTTP Accelerator',
    'X-Varnish-Grace': 'Varnish HTTP Accelerator',
    'X-Varnish-HitMiss': 'Varnish HTTP Accelerator',
    'X-Varnish-Host': 'Varnish HTTP Accelerator',
    'X-Varnish-ID': 'Varnish HTTP Accelerator',
    'X-Varnish-Secret': 'Varnish HTTP Accelerator',
    'X-Varnish-Server': 'Varnish HTTP Accelerator',
    'X-Varnish-Timing': 'Varnish HTTP Accelerator',
    'X-Varnish-TTL': 'Varnish HTTP Accelerator',
    'X-Varnish-URL': 'Varnish HTTP Accelerator',
    'X-Vcap-Request-Id': 'cloudfoundry.org Platform',
    'X-Vercel-Cache': 'vercel.com Cache',
    'X-Vercel-Deployment-URL': 'vercel.com Cache',
    'X-Vercel-Error': 'vercel.com Cache',
    'X-Vercel-Execution-Region': 'vercel.com Cache',
    'X-Vercel-Forwarded-For': 'vercel.com Cache',
    'X-Vercel-ID': 'vercel.com Cache',
    'X-Vercel-IP-As-Number': 'vercel.com Cache',
    'X-Vercel-IP-City': 'vercel.com Cache',
    'X-Vercel-IP-Continent': 'vercel.com Cache',
    'X-Vercel-IP-Country': 'vercel.com Cache',
    'X-Vercel-IP-Country-Region': 'vercel.com Cache',
    'X-Vercel-IP-Latitude': 'vercel.com Cache',
    'X-Vercel-IP-Longitude': 'vercel.com Cache',
    'X-Vercel-IP-Timezone': 'vercel.com Cache',
    'X-Vercel-Signature': 'vercel.com Cache',
    'X-Version': 'Generic Software Version ID',
    'X-Version-Id': 'Generic Software Version ID',
    'X-Vingle-API-Region': 'vingle.net Platform',
    'X-Vingle-Authentication-Token': 'vingle.net Platform',
    'X-Vingle-Request-ID': 'vingle.net Platform',
    'X-Vingle-Time': 'vingle.net Platform',
    'X-Vingle-UDID': 'vingle.net Platform',
    'X-Vingle-User-Agent': 'vingle.net Platform',
    'X-Virus-Infected': 'Microsoft SharePoint Services',
    'X-Volterra-Location': 'F5 Volterra',
    'X-VServer': 'Varnish HTTP Accelerator',
    'X-Vtex-Backend-Elapsed-Time': 'vtex.com Platform',
    'X-Vtex-Cache-Backend-Connect-Time': 'vtex.com Platform',
    'X-Vtex-Cache-Backend-Header-Time': 'vtex.com Platform',
    'X-Vtex-Cache-Server': 'vtex.com Platform',
    'X-Vtex-Cache-Status': 'vtex.com Platform',
    'X-Vtex-Cache-Status-Janus-Apicache': 'vtex.com Platform',
    'X-Vtex-Cache-Time': 'vtex.com Platform',
    'X-Vtex-Etag-Control': 'vtex.com Platform',
    'X-Vtex-IO-Cluster-ID': 'vtex.com Platform',
    'X-Vtex-Janus-Router-Backend-App': 'vtex.com Platform',
    'X-Vtex-Processado-EM': 'vtex.com Platform',
    'X-Vtex-Processed-AR': 'vtex.com Platform',
    'X-Vtex-Processed-AT': 'vtex.com Platform',
    'X-Vtex-Product': 'vtex.com Platform',
    'X-Vtex-Remote-Cache': 'vtex.com Platform',
    'X-Vtex-Renderer': 'vtex.com Platform',
    'X-Vtex-Router-Elapsed-Time': 'vtex.com Platform',
    'X-Vtex-Router-Version': 'vtex.com Platform',
    'X-Webcom-Cache-Status': 'web.com Platform',
    'X-Wix-Renderer-Server': 'Wix.com Publishing Software',
    'X-Wix-Request-Id': 'Wix.com Publishing Software',
    'X-Wix-Server-Artifact-Id': 'Wix.com Publishing Software',
    'X-WP-CF-Fallback-Cache': 'Super Page Cache for Cloudflare WordPress Plugin',
    'X-WP-CF-Super-Cache': 'Super Page Cache for Cloudflare WordPress Plugin',
    'X-WP-CF-Super-Cache-Active': 'Super Page Cache for Cloudflare WordPress Plugin',
    ...
    'X-WS-Ratelimit-Limit': 'ionos.com Platform',
    'X-WS-Ratelimit-Remaining': 'ionos.com Platform',
    ...
    'X-Yottaa-OS': 'yottaa.com Platform',
    'X-Yottaa-Sig': 'yottaa.com Platform',
    'X-Zen-Fury': 'ZenEdge Web Application Firewall',
    'X-Zendesk-User-ID': 'Zendesk Customer Relationship Management',
    'YJS-CacheStatus': 'Yunjiasu Content Delivery Network',
    'YJS-ID': 'Yunjiasu Content Delivery Network',
    'Yunjiasu-Nginx': 'Yunjiasu HTTP Server'
};
